...
public class AdminManageUsersController {
    ...
    private HBox createUserCard(String id, String username, String email, String role) {
        ...
        // Avatar
        Circle avatarCircle = new Circle(20, Color.valueOf("#3B82F6"));
        Label avatarLabel = new Label(username.substring(0, Math.min(2, username.length())).toUpperCase());
        ...
        lblUsername.setStyle("-fx-text-fill: white; -fx-font-weight: bold; -fx-font-size: 16px;");
        Label lblEmail = new Label(email);
        lblEmail.setStyle("-fx-text-fill: #9CA3AF; -fx-font-size: 13px;");
        Label lblRole = new Label(role);
        lblRole.setStyle("-fx-text-fill: #F59E0B; -fx-font-size: 12px; -fx-font-weight: bold;");
        ...
        if (!"ADMIN".equalsIgnoreCase(role)) {
            ...
            btnBan.setStyle("-fx-background-color: #EF4444; -fx-text-fill: white; -fx-font-weight: bold; -fx-padding: 6 16; -fx-background-radius: 6; -fx-cursor: hand;");
            btnBan.setOnAction(e -> handleBanUser(id));

            Button btnUnban = new Button("🔓 Mở khóa");
            btnUnban.setStyle("-fx-background-color: #10B981; -fx-text-fill: white; -fx-font-weight: bold; -fx-padding: 6 16; -fx-background-radius: 6; -fx-cursor: hand;");
            ...
            adminBadge.setStyle("-fx-text-fill: #3B82F6; -fx-font-weight: bold;");
