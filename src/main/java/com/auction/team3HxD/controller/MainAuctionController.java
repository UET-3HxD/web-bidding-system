...
MainAuctionController {
    ...
    @FXML private VBox vboxAuctionList;
    ...
    @FXML private Label lblDetailBidCount;
    @FXML private Label lblDetailDesc;
    @FXML private Label lblDetailCurrentPrice;
    @FXML private Label lblDetailTimeLeft;
    ...
    private HBox createAuctionCardUI(AuctionSessionDTO auction) {
        ...
        card.setOnMouseClicked(event -> {
            ...
            vboxAuctionList.getChildren().forEach(node -> node.getStyleClass().remove("auction-card-selected"));
    ...
    private void clearDetailPanel() {
        ...
        lblDetailDesc.setText("Vui lòng chọn một phiên đấu giá từ danh sách bên trái để xem chi tiết...");
    ...
    void handleGoToBidRoom(ActionEvent event) {
        ...
        String currentUserId = String.valueOf(com.auction.team3HxD.util.UserSession.getInstance().getId());
        ...
        System.out.println(">>> Đang điều hướng sang phòng đặt giá cho Auction ID: " + selectedAuctionId);
        try {
