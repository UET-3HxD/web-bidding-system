...
public class ProductManagementController {
            ...
            if (message.equals("CREATE_ITEM_SUCCESS")) {
                ...
                Platform.runLater(() -> {
                    ...
                    if (parts.length >= 3) {
                        ...
                        Alert alert = new Alert(status.equals("APPROVED") ? Alert.AlertType.INFORMATION : Alert.AlertType.WARNING);
    ...
    @FXML void handleGoToAuction(ActionEvent event) { SceneSwitcher.getInstance().switchTo("/fxml/main_auction.fxml", (Node) event.getSource(), "Sàn đấu giá"); }
